...
[![sampctl](https://shields.southcla.ws/badge/sampctl-y_bit-2f2f2f.svg?style=for-the-badge)](https://github.com/YSI-Data/y_bit)
...
```bash
sampctl package install YSI-Data/y_bit
```
...
* [Quick Start](YSI-Data/y_bit/quick-start.md) - One very simple example of getting started with this library.
* [Features](YSI-Data/y_bit/features.md) - More features and examples.
* [FAQs](YSI-Data/y_bit/faqs.md) - Frequently Asked Questions, including errors and solutions.
* [API](YSI-Data/y_bit/api.md) - Full list of all functions and their meaning.
* [Internal](YSI-Data/y_bit/internal.md) - Internal developer documentation for the system.
